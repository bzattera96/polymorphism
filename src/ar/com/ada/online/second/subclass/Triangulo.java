...
public class Triangulo extends FiguraGeometrica {
    ...
    public Triangulo(String nombre, double ladoA, double ladoB, double ladoC, double altura) {
        super(nombre);
        this.ladoA = ladoA;
        this.ladoB = ladoB;
        this.ladoC = ladoC;
    ...
    public String toString() {
        return "Triangulo: el lado " + ladoA + " multiplicado por el lado " + altura + " dividido 2, da un area de: " + calcularArea() + ". Es isometrico? " + esIsometrica() + ".";
    }
